...
import imageio
import numpy
from carla import VehicleLightState as vls, Location, Rotation
import logging
...
def sensor_callback(sensor_data, sensor_queue, timer, sensor, world):
...
def main():
    ...
    try:
        ...
        for n, transform in enumerate(spawn_points):
            ...
            x = SpawnActor(blueprint, spawn_points[76])
        ...
        print("Fx = Fy = %f || Cy =  %f|| Cx = %f||" % (focal, image_h / 2.0, image_w / 2.0))
        ...
        print(all_vehicle_actors[0].get_transform())
        world.tick()
        sensor.destroy()
