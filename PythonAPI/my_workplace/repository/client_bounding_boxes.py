...
class BasicSynchronousClient(object):
    ...
    def setup_car(self):
        ...
        car_bp = car_bp.find('vehicle.tesla.model3')
    ...
    def setup_camera(self):
        ...
        camera_transform = carla.Transform(carla.Location(x=1, y=0, z=1.2), carla.Rotation(pitch=0.75))
    ...
    def set_image(weak_self, img):
        ...
        if self.capture:
            self.image = img
            self.capture = False
            #self.image.save_to_disk('output/%06d.png' % self.image.frame)
