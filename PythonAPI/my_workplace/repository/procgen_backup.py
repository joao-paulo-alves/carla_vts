...
def main():
    ...
    try:
        ...
        attr.set_attribute('sensor_tick', '0.041667')  # '0.000277
        llocation = carla.Location(1, 0, 1.2)
        rrotation = carla.Rotation(8.75, 0, 0)
        ttransform = carla.Transform(llocation, rrotation)

        sensor = world.spawn_actor(attr, ttransform, attach_to=all_vehicle_actors[0],
